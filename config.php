<?php 
    ...
    define('API_HOBOHOST','http://localhost:80/api_hobohost/get_data.php');
    define('API_HOBOHOST_UPDATE_STATUS_SENDING','http://localhost:80/api_hobohost/update_job.php');
?>